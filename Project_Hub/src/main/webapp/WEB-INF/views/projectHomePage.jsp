								...
								<div class="taskReport_content">
									...
									<div class="task_report_list">
										<ul id="task_report_list_ul">
											<c:if test="${taskReport_number[0] ne '0'}">
												<li style="margin-bottom: 16px;"><span class="task_report_request"> <i class="fa-solid fa-circle fa-xs"></i> <span class="task_report_text">요청 <em>${taskReport_number[1]}</em>
													</span> <span class="task_report_request_percent"></span> <span class="request_percent">%</span>
												</span> <span class="task_report_progress"> <i class="fa-solid fa-circle fa-xs"></i> <span class="task_report_text">진행 <em>${taskReport_number[2]}</em>
													</span> <span class="task_report_progress_percent"></span> <span class="progress_percent">%</span>
												</span></li>
												<li><span class="task_report_complete"> <i class="fa-solid fa-circle fa-xs"></i> <span class="task_report_text">완료 <em>${taskReport_number[3]}</em>
													</span> <span class="task_report_complete_percent"></span> <span class="complete_percent">%</span>
												</span> <span class="task_report_hold"> <i class="fa-solid fa-circle fa-xs"></i> <span class="task_report_text">보류 <em>${taskReport_number[4]}</em>
